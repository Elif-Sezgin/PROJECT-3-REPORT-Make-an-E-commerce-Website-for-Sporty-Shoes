              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Today Deal</h1>
                      <img class="img-fluid" src="https://www.sneakersnstuff.com/images/49683/open_graph.jpg" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3"> NIKE</h2>
                      <p class="cr4"> Click buy to see all lists of products </p>
                      <div class="rating">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today's Deals</h1>
                  <img class="img-fluid" src="https://cdnd.lystit.com/photos/jdsports/6e816405/adidas-Green-Alpha-Bounce-Beyond.jpeg">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1></h1>
                  <img class="img-fluid" src="https://www.sporthink.com.tr/UserFiles/ProductImages/0/pu366962u/orj/puma-ayakkabi-turin-ii-04-75501.jpg">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
